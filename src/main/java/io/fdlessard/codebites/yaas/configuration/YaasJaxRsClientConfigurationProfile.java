 ...
 */
@Configuration
@Profile("YaasJaxRsClientProfile")
public class YaasJaxRsClientConfigurationProfile {

    private static final Logger LOGGER = LoggerFactory.getLogger(YaasJaxRsClientConfigurationProfile.class);
    ...
    public CustomerAccountGateway getCustomerAccountGateway() {
        return new CustomerAccountJaxRsGateway();
    }
